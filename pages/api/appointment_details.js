...
const uri = process.env.MONGODB_URI || 'your-mongodb-connection-string-here';

export default async function handler(req, res) {
  const { lookup_key, lookup_type } = req.body;  // Note: removed .args
  ...
  try {
    ...
    // Return appointment data in the format your voice agent expects
